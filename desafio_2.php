...
function isVerboPrimeiraPessoa($grupoFoo, $palavra) {
    foreach ($grupoFoo as $foo) {
        if ($palavra[0] == $foo) {
            return true;
        }
...
// Resposta: Total de Verbos: 142, Verbos Primeira Pessoa: 30
imprimirQuantidadeVerbos($texto, $grupoFoo);

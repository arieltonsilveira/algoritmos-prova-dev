...
$alfabeto_br = ['a', 'b', 'c', 'd', 'e', 'f', 'g', 'h', 'i', 'j', 'k', 'l', 'm', 'n', 'o', 'p', 'q', 'r', 's', 't'];

$alfabeto_googlons = ['s', 'k', 'm', 'g', 'n', 'w', 'q', 'z', 't', 'x', 'd', 'r', 'p', 'c', 'f', 'j', 'l', 'b', 'v', 'h'];

imprimirLista($textoB, montarArrayAlfabeto($alfabeto_googlons, $alfabeto_br));
